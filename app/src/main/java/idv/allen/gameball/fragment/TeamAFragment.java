...
public class TeamAFragment extends Fragment {
    private RecyclerView rvTeamA;
    TeamCheckAdapter teamCheckAdapter;
    List<RosterVO> rosterVOList;
    private Bundle bundle;
    private Button btnAbandonTeamA,btnCheckTeamA;
    ...
    class SendCheckTeamATask extends AsyncTask<GamedayVO,Void,Boolean> {

        @Override
        protected Boolean doInBackground(GamedayVO... params) {
            GamedayDAO_interface dao = new GamedayDAO();
            return dao.updateTeamACheck(params[0]);
        }
    }

    class SendTeamARosterTask extends AsyncTask<List<RosterVO>,Void,Void> {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rvTeamA = (RecyclerView) view.findViewById(R.id.rvTeamA);
        btnAbandonTeamA = (Button) view.findViewById(R.id.btnAbandonTeamA);
        btnCheckTeamA = (Button) view.findViewById(R.id.btnCheckTeamA);
        //set onclick listener of two button
        btnCheckTeamA.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        touchHelper.attachToRecyclerView(rvTeamA);
        return view;
    }

    boolean b;
    public void onCheckTeamAClick (View v) {
        SendTeamARosterTask task1 = new SendTeamARosterTask();
...
//            });
            ...
            pDialog.setContentText(bundle.getString("teamAName")+"報到成功！");
            pDialog.show();
    ...
    public void onAbandonTeamAClick (View v) {
        GamedayVO gamedayVO = new GamedayVO();
        gamedayVO.setGameday_id(gameday_id);
        gamedayVO.setTeam_a_check("棄賽");
        SendCheckTeamATask task = new SendCheckTeamATask();
        try {
            b = task.execute(gamedayVO).get();
        } catch (InterruptedException e) {
...
//            });
            ...
            pDialog.setContentText(bundle.getString("teamAName")+"放棄比賽...");
            pDialog.show();
        } else {
            Toast.makeText(getActivity(),"再試一次.....",Toast.LENGTH_SHORT).show();
        }
